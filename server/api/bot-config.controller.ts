...
export class BotConfigApiController {
  ...
  @Get('/rasa-server')
  async getRasaServerList(@Query('skip') skip: number, @Query('size') size: number): Promise<RasaServer[]> {
  ...
  async createRasaServer(@Body('name') name: string, @Body('url') url: string, @Body('isActive') isActive: boolean): Promise<RasaServer> {
  ...
  async updateRasaServer(@Body('id') id: number, @Body('name') name: string, @Body('url') url: string, @Body('isActive') isActive: boolean): Promise<RasaServer> {
  ...
  @Get('/route')
  async getRouteList(@Query('skip') skip: number, @Query('size') size: number): Promise<Route[]> {
  ...
  @Post('/route/create')
  async createRoute(@Body('sourceType') sourceType: RouteType, @Body('sourceName') sourceName: string, @Body('destinationType') destinationType: RouteType, @Body('destinationName') destinationName: string, @Body('isActive') isActive: boolean): Promise<Route> {
  ...
  @Post('/route/update')
  async updateRoute(@Body('id') id: number, @Body('sourceType') sourceType: RouteType, @Body('sourceName') sourceName: string, @Body('destinationType') destinationType: RouteType, @Body('destinationName') destinationName: string, @Body('isActive') isActive: boolean): Promise<Route> {
