...
export interface WxkfAccessToken {
  access_token?: string;
  expires_in?: number;
}
...
export class WxkfIncomingEventMessage extends WxkfIncomingMessage {
  ...
  @Type(() => WxkfIncomingEvent, {
    ...
    discriminator: {
      property: 'event_type',
      subTypes: [
        { value: WxkfEnterSessionEvent, name: WxkfIncomingEventType.EnterSession },
        { value: WxkfMsgSendFailEvent, name: WxkfIncomingEventType.MsgSendFail },
      ],
    },
  })
...
export class WxkfSyncMsgResponse {
  errcode: number;
  errmsg: string;
  next_cursor?: string;
  has_more?: 0 | 1;
  ...
  @Type(() => WxkfIncomingMessage, {
    ...
    discriminator: {
      ...
      subTypes: [
        ...
        { value: WxkfIncomingImageMessage, name: WxkfIncomingMessageType.Image },
        { value: WxkfIncomingVoiceMessage, name: WxkfIncomingMessageType.Voice },
        { value: WxkfIncomingVideoMessage, name: WxkfIncomingMessageType.Video },
        { value: WxkfIncomingFileMessage, name: WxkfIncomingMessageType.File },
        { value: WxkfIncomingLocationMessage, name: WxkfIncomingMessageType.Location },
        { value: WxkfIncomingEventMessage, name: WxkfIncomingMessageType.Event },
      ],
    },
  })
  ...
  @Type(() => WxkfMessagePayload, {
    ...
    discriminator: {
      ...
      subTypes: [
        ...
        { value: WxkfMiniprogramMessagePayload, name: WxkfMessageType.Miniprogram },
